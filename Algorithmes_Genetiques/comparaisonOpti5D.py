...
## PLOTS
files = ["SCIPY-epsilonContraintes/optimisation5dScipy.txt",
         "NSGAII/optimisation5dNSGAII.txt"]

legende = ["scipy : epsilon-Contrainte",
        "NSGAII"]
algo = ["SCIPY","NSGAII"]
...
plt.title('Comparaison problème de 5D',fontsize=14)
fig1.tight_layout()
plt.legend()
